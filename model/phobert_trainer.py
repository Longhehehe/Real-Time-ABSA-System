...
if __name__ == "__main__":
    ...
    DATA_PATH = os.path.join(PROJECT_DIR, 'data', 'label', 'absa_labeled_mistral.csv')
    OUTPUT_DIR = os.path.join(PROJECT_DIR, 'models', 'phobert_absa')
    
    # Check if file exists, if not fall back
    if not os.path.exists(DATA_PATH):
        print(f"⚠️ New dataset not found at {DATA_PATH}, falling back to old test data.")
        DATA_PATH = os.path.join(PROJECT_DIR, 'data', 'label', 'absa_grouped_vietnamese_test.xlsx')
